...
DD = 0
result = np.array([
    [DD, XX,  1,  1,  2,  2,  1,  2],#FL
    [XX, DD,  2,  0,  0,  2,  2,  2],#CR
    [ 2,  1, DD,  2,  2, XX,  2,  2],#SZ
    [ 2,  2,  1, DD, XX,  2,  2,  2],#JDT
    [ 1,  2,  0, XX, DD,  2,  2,  0],#NTH
    [ 1,  0, XX,  0,  0, DD,  2,  2],#CGZ
    [ 2,  1,  0,  0,  0,  0, DD, XX],#SG
    [ 0,  0,  1,  0,  2,  0, XX, DD],#IGZ
#    FL  CR  SZ JDT NTH CGZ  SG IGZ
])
