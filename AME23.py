...
DD = 0
result = np.array([
    [DD,  0,  2,  2,  2,  2,  0, XX,  0,  1],#100T
    [ 2, DD,  2,  2, XX,  2,  1,  2,  2,  2],#C9
    [ 0,  0, DD,  1,  2,  2,  1,  2, XX,  2],#EG
    [ 1,  0,  2, DD,  2,  2,  0,  2,  1, XX],#FUR
    [ 1, XX,  1,  0, DD,  0,  1,  1,  0,  0],#KRU
    [ 1,  0,  1,  1,  2, DD, XX,  2,  2,  2],#LEV
    [ 2,  2,  2,  2,  2, XX, DD,  2,  0,  2],#LOUD
    [XX,  0,  0,  0,  2,  0,  1, DD,  2,  0],#MIBR
    [ 2,  1, XX,  2,  2,  0,  2,  1, DD,  2],#NRG
    [ 2,  0,  0, XX,  2,  1,  1,  2,  0, DD],#SEN
#   100T C9  EG FUR KRU LEV LOUD MIBR NRG SEN  
])
